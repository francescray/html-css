...
@section('nav')
	<div class="nav-search"><a href="{{ Url('demand/page/warehouse') }}">人员需求信息</a></div>
...
@section('content')
	<div class="container">
		<div class="supply-demand">
			<div ><a href="{{ url('supply/s/personal') }}">全部人员供应</a></div>
				<div class="select"><a href="{{ url('demand/s/personal') }}">全部人员需求</a></div>
			</div>
		                ...
		                <tbody>
							@foreach($demands as $demand)
	                            <tr class="personal-one">
	                                <td class="personal-title" width="40%"><a href="{{ url("demand/{$demand->demand->id}") }}">{!! str_replace(request('title'), '<font color="red">' . request('title') . '</font>', htmlspecialchars($demand->demand->title)) !!}&nbsp;&nbsp;&nbsp;要求(
