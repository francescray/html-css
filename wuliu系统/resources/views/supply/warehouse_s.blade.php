...
@section('nav')
	<div class="nav-search"><a href="{{ Url('supply/page/warehouse') }}">仓库供应信息</a></div>
...
@section('content')
	<div class="container">
		<div class="supply-demand">
			<div class="select"><a href="{{ url('supply/s/warehouse') }}">全部仓库供应</a></div>
			<div><a href="{{ url('demand/s/warehouse') }}">全部仓库需求</a></div>
		</div>
