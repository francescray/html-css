...
@section('nav')
    ...
    <div class="nav-search">发出的而合作意向</div>
@endsection
	...
	<div class="mainbody">
        <div class="container">
            ...
            <div class="right">
                <div class="firstpart">
                    <div class="instruct">
                        <div class="instruct-name">发出的合作意向</div>
                ...
                <div class="secondpart">
                    ...
                    <div class="message-released">
                        ...
                        <div class="message-head">
                            <div class="my-message">{{ $coop->res->user->name or $coop->res->user->username }} 发布的{{ $coop->res->type->name }}信息：</div>
